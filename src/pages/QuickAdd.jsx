      ...
      {historico.length > 0 && (
        <div>
          ...
          <div className="space-y-1">
            {historico.map((h) => (
              <button key={h} onClick={() => setTexto(h)} className="block w-full text-left text-sm rounded-xl px-3 py-2 glass-soft border border-white/10 hover:border-[#f6d353]/40">
                “{h}”
              </button>
            ))}
          </div>
